...
namespace DataContext.Migrations
{
    ...
    [Migration("20210620071840_initialBlog&VideosTables")]
    partial class initialBlogVideosTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Entites.Blog.Blog", b =>
                {
            ...
            modelBuilder.Entity("Models.Entites.Blog.BlogCategory", b =>
                {
            ...
            modelBuilder.Entity("Models.Entites.Blog.BlogSelectedCategory", b =>
                {
            ...
            modelBuilder.Entity("Models.Entites.Blog.Video", b =>
                {
            ...
            modelBuilder.Entity("Models.Entites.Blog.VideoSelectedCategory", b =>
                {
            ...
            modelBuilder.Entity("Models.Entites.Comment.Comment", b =>
                {
            ...
            modelBuilder.Entity("Models.Entites.Blog.BlogSelectedCategory", b =>
                {
                    b.HasOne("Models.Entites.Blog.BlogCategory", "BlogCategory")
                        .WithMany("BlogSelectedCategory")
                        .HasForeignKey("BlogCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Models.Entites.Blog.Blog", "Blog")
                        .WithMany("BlogSelectedCategory")
            ...
            modelBuilder.Entity("Models.Entites.Blog.VideoSelectedCategory", b =>
                {
                    ...
                    b.HasOne("Models.Entites.Blog.Video", "Video")
                        .WithMany("VideoSelectedCategory")
            ...
            modelBuilder.Entity("Models.Entites.Comment.Comment", b =>
                {
                    ...
                    b.HasOne("Models.Entites.Comment.Comment", null)
                        .WithMany("comments")
